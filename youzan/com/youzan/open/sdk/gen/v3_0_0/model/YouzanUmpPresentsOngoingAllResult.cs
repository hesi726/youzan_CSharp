...
namespace com.youzan.open.sdk.gen.v3_0_0.model
{
    ...
    public class YouzanUmpPresentsOngoingAllResult : APIResult
	{
		...
		/// 赠品列表
		/// </summary>
[Newtonsoft.Json.JsonProperty("presents")]//) private UmpPresent[] presents;
		private UmpPresent[] presents;

		public virtual UmpPresent[] Presents
		{
			set
			{
				this.presents = value;
...
[Newtonsoft.Json.JsonProperty("created")]//) private java.util.Date created;
			...
			/// 领取限制，每个人限领多少个，必须大于0
			/// </summary>
[Newtonsoft.Json.JsonProperty("fetch_limit")]//) private Nullable<long> fetchLimit;
				internal long? fetchLimit;
				...
				public virtual long? FetchLimit
				{
					set
					{
