...
namespace com.youzan.open.sdk.gen.v3_0_0.model
{
    ...
    public class YouzanPaySubmerchantUpdateParams : APIParams, FileParams
	{
		...
		/// 经营资质图片
		/// </summary>
		private string businessCertificatePhotoUri;
		/// <summary>
		/// 营业执照号
		/// </summary>
		...
		/// <summary>
		/// 证件类型:0 其他 1 普通营业执照（存在独立的组织机构代码证） 2 多证合一营业执照（不存在独立的组织机构代）
		/// </summary>
		...
		/// <summary>
		/// 1: 中国大陆身份证 2: 香港身份证 3: 台湾身份证 4: 澳门身份证 5: 中国大陆护照 6: 港澳通行证 7: 台湾通行证
		/// </summary>
		...
		public virtual string BusinessCertificatePhotoUri
		{
			set
			{
				this.businessCertificatePhotoUri = value;
			}
			get
			{
				return this.businessCertificatePhotoUri;
			}
		}
		...
		public virtual long? BusinessType
		{
			set
			{
		...
		public virtual string CoreBusiness
		{
			set
			{
				this.coreBusiness = value;
			}
			get
			{
		...
		public virtual string MerchantShortName
		{
			set
			{
		...
		public virtual string ServiceDescAttachments
		{
			set
			{
				this.serviceDescAttachments = value;
			}
			get
			{
		...
		public virtual IDictionary<string, object> toParams()
		{
			...
			if (!string.ReferenceEquals(businessCertificatePhotoUri, null))
			{
				@params["business_certificate_photo_uri"] = businessCertificatePhotoUri;
			}
			...
			if (!string.ReferenceEquals(coreBusiness, null))
			{
				@params["core_business"] = coreBusiness;
			}
			...
			if (!string.ReferenceEquals(merchantShortName, null))
			{
				@params["merchant_short_name"] = merchantShortName;
			}
			...
			if (!string.ReferenceEquals(serviceDescAttachments, null))
			{
				@params["service_desc_attachments"] = serviceDescAttachments;
			}
			if (!string.ReferenceEquals(serviceTel, null))
			{
				@params["service_tel"] = serviceTel;
			}
			if (!string.ReferenceEquals(webSiteUrl, null))
			{
				@params["web_site_url"] = webSiteUrl;
			}
			return @params;
		}
