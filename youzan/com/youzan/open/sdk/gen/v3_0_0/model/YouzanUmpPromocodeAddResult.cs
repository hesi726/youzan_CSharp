...
namespace com.youzan.open.sdk.gen.v3_0_0.model
{
    ...
    public class YouzanUmpPromocodeAddResult : APIResult
	{
		...
		/// 优惠码
		/// </summary>
[Newtonsoft.Json.JsonProperty("promocode")]//) private UmpPromotionCode promocode;
		private UmpPromotionCode promocode;

		public virtual UmpPromotionCode Promocode
		{
			set
			{
...
[Newtonsoft.Json.JsonProperty("range_type")]//) private String rangeType;
			...
			/// <br>GENERAL 通用码
			/// </summary>
[Newtonsoft.Json.JsonProperty("code_type")]//) private String codeType;
				internal string codeType;
...
[Newtonsoft.Json.JsonProperty("is_expired")]//) private Nullable<long> isExpired;
			...
			/// </summary>
[Newtonsoft.Json.JsonProperty("is_ongoing")]//) private Nullable<long> isOngoing;
				internal long? isOngoing;
...
[Newtonsoft.Json.JsonProperty("fetch_url")]//) private String fetchUrl;
			...
			/// 用户标签
			/// </summary>
[Newtonsoft.Json.JsonProperty("mark_tags")]//) private CrmUserTag[] markTags;
				internal CrmUserTag[] markTags;


			/// <summary>
			/// 商品数据结构
			/// </summary>
[Newtonsoft.Json.JsonProperty("specify_items")]//) private GoodsDetail[] specifyItems;
				internal GoodsDetail[] specifyItems;
...
[Newtonsoft.Json.JsonProperty("created")]//) private java.util.Date created;
			...
			/// 同步微信卡券，选择的卡券颜色的值
			/// </summary>
[Newtonsoft.Json.JsonProperty("weixin_color")]//) private String weixinColor;
				internal string weixinColor;


			/// <summary>
			/// 同步微信卡券，选择的卡券颜色的RGB值
			/// </summary>
[Newtonsoft.Json.JsonProperty("weixin_color_rgb")]//) private String weixinColorRgb;
				internal string weixinColorRgb;


			/// <summary>
			/// 同步微信卡券，卡券的标题
			/// </summary>
[Newtonsoft.Json.JsonProperty("weixin_title")]//) private String weixinTitle;
				internal string weixinTitle;


			/// <summary>
			/// 同步微信卡券，卡券的副标题
			/// </summary>
[Newtonsoft.Json.JsonProperty("weixin_sub_title")]//) private String weixinSubTitle;
				internal string weixinSubTitle;
...
[Newtonsoft.Json.JsonProperty("service_phone")]//) private String servicePhone;
				internal string servicePhone;


			/// <summary>
			/// 同步微信卡券，设置是否可以转赠，1 为可转赠，0 为不可转赠
			/// </summary>
[Newtonsoft.Json.JsonProperty("can_give_friend")]//) private Nullable<long> canGiveFriend;
				internal long? canGiveFriend;
				...
				public virtual CrmUserTag[] MarkTags
				{
					set
					{
					this.markTags = value;
				...
				public virtual GoodsDetail[] SpecifyItems
				{
					set
					{
					this.specifyItems = value;
					}
					get
					{
