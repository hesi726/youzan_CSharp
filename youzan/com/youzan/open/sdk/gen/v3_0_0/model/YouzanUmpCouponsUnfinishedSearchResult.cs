...
namespace com.youzan.open.sdk.gen.v3_0_0.model
{
    ...
    public class YouzanUmpCouponsUnfinishedSearchResult : APIResult
	{
		...
		/// 未结束的优惠券组列表
		/// </summary>
[Newtonsoft.Json.JsonProperty("coupons")]//) private UmpCoupon[] coupons;
		private UmpCoupon[] coupons;

		public virtual UmpCoupon[] Coupons
		{
			set
			{
				this.coupons = value;
