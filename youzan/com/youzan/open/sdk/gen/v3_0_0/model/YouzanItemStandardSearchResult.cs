namespace com.youzan.open.sdk.gen.v3_0_0.model
{
    ...
    public class YouzanItemStandardSearchResult : APIResult
	{
...
[Newtonsoft.Json.JsonProperty("count")]//) private Nullable<long> count;
		...
		/// 查询到的商品标准列表
		/// </summary>
[Newtonsoft.Json.JsonProperty("item_standards")]//) private ItemStandardOpenModel[] itemStandards;
		...
		public virtual ItemStandardOpenModel[] ItemStandards
		{
			set
			{
				this.itemStandards = value;
			}
			get
			{
