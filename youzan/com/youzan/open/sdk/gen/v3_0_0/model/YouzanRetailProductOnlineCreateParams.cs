...
namespace com.youzan.open.sdk.gen.v3_0_0.model
{
    ...
    public class YouzanRetailProductOnlineCreateParams : APIParams, FileParams
	{
		...
		/// <summary>
		/// 商品参与平台 0：普通商品 10：分销平台。目前仅支持普通商品
		/// </summary>
		private long? goodsPlatform;
		/// <summary>
		/// 商品类型：0：普通商品，1: 拍卖商品, 3：ump降价拍，10:分销商品；20：会员卡商品；25：批发商品；30：收银台商品；35：酒店商品。 目前仅支持普通商品
		/// </summary>
		...
		public virtual long? RelatedSkuId
		{
			set
			{
				this.relatedSkuId = value;
			}
			get
			{
		...
		public virtual IDictionary<string, object> toParams()
		{
			...
			{
				@params["related_sku_id"] = relatedSkuId;
			}
