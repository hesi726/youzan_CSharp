...
namespace com.youzan.open.sdk.gen.v3_0_1.model
{
    ...
    public class YouzanUsersWeixinFollowersPullResult : APIResult
	{
		...
		/// 搜索到的微信粉丝用户列表
		/// </summary>
[Newtonsoft.Json.JsonProperty("users")]//) private CrmWeixinFans[] users;
...
[Newtonsoft.Json.JsonProperty("last_fans_id")]//) private Nullable<long> lastFansId;
		...
		public virtual CrmWeixinFans[] Users
		{
			set
			{
				this.users = value;
